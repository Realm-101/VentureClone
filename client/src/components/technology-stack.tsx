...
import { Info, ExternalLink, Code, Database, Palette, BarChart, Shield, Zap } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export function TechnologyStack({ aiInferredTech, detectedTech, complexityScore }: TechnologyStackProps) {
